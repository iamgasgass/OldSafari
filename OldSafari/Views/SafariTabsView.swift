...
struct SafariLegacyButtonStyle: ButtonStyle {
    ...
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .foregroundColor(destructive ? Color(red: 0.55, green: 0.02, blue: 0.02) : Color(red: 0.04, green: 0.14, blue: 0.34))
            .padding(.horizontal, compact ? 9 : 13)
            .frame(minHeight: compact ? 30 : 36)
            .background(LinearGradient(colors: configuration.isPressed ? [Color(red: 0.56, green: 0.63, blue: 0.73), Color(red: 0.84, green: 0.88, blue: 0.93)] : highlighted ? [Color(red: 0.72, green: 0.80, blue: 0.91), Color.white] : [Color.white, Color(red: 0.70, green: 0.76, blue: 0.84)], startPoint: .top, endPoint: .bottom))
            .overlay(alignment: .top) { Rectangle().fill(Color.white.opacity(configuration.isPressed ? 0.20 : 0.72)).frame(height: 1) }
            .overlay(RoundedRectangle(cornerRadius: 5).stroke(Color(red: 0.15, green: 0.21, blue: 0.30), lineWidth: 1))
...
struct SafariLegacyNavigationBar<Leading: View, Trailing: View>: View {
    ...
    var body: some View { ZStack { LinearGradient(colors: [Color(red: 0.88, green: 0.91, blue: 0.95), Color(red: 0.45, green: 0.53, blue: 0.64)], startPoint: .top, endPoint: .bottom).overlay(alignment: .top) { Rectangle().fill(Color.white.opacity(0.55)).frame(height: 1) }; HStack { leading.frame(width: 86, alignment: .leading); Spacer(); Text(title).font(.system(size: 18, weight: .bold)).foregroundColor(.white).shadow(color: .black.opacity(0.75), radius: 0, x: 0, y: -1).shadow(color: .black.opacity(0.30), radius: 1, x: 0, y: 1); Spacer(); trailing.frame(width: 86, alignment: .trailing) }.padding(.horizontal, 8) }.frame(height: 60).overlay(alignment: .bottom) { Rectangle().fill(Color.black.opacity(0.48)).frame(height: 1) } }
}
