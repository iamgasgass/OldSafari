...
// NOTA: la struct `OldOSTableFiller` (griglia di separatori fantasma per
// riempire lo spazio vuoto sotto l'ultima riga) è stata rimossa: era codice
// morto, non referenziato da nessuna vista del progetto, e riproduceva
// esattamente il pattern di righe extra segnalato nelle schermate Downloads
// e Cronologia. Nessun altro file la richiama, quindi la rimozione è sicura.
